...
- **Customize the look.** Use `/customize-widget` in Discord to set your brand color, header text, and branding — changes apply instantly, no redeploy required.
...
- **Simple Widget** — embed in 30 seconds, customizable brand color and branding, mobile-responsive, no code required beyond the embed snippet.
...
| `/customize-widget`        | Set your widget's brand color, header text, and branding                             |
