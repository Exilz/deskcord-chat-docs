...
Yes — use `/customize-widget` to set your brand color, header text, and branding. Every accent in the widget updates to match, so it feels native to your site.

**Where does the widget appear on my site?**
As a chat bubble in the bottom-right corner. It's mobile-responsive and works on all devices.
